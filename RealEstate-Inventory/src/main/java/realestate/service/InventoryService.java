...
import realestate.config.InventoryConfig;
import realestate.util.InventoryBuildUtil;
...
public class InventoryService {
	...
	private int sendMessage(String mail, Session session) throws AddressException, MessagingException {
		...
		message.setDataHandler(new DataHandler(new HTMLDataSource(InventoryBuildUtil.build(mail))));
